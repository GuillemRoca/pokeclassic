...
// Key items
    ...
    {
        .name = _("Plans Rocket"),
        .itemId = ITEM_ROCKET_PLANS,
        .price = 0,
        .description = sRocketPlansDesc,
        .importance = 2,
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
