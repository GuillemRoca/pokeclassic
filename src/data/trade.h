...
static const u8 sText_SpaceMove[] = _(" MOV."); // unused
...
static const u8 sText_IsThisTradeOkay[] = _("Acceptes l'intercanvi?");
static const u8 sText_Cancel[] = _("Cancel·lar");
static const u8 sText_ChooseAPkmn[] = _("Tria un Pokémon.");
static const u8 sText_Summary[] = _("Resum");
static const u8 sText_Trade[] = _("Intercanvi");
static const u8 sText_CancelTrade[] = _("Cancel·lar intercanvi?");
static const u8 sJPText_PressBButtonToQuit[] = _("Bボタン　で　もどります");
static const u8 sText_Summary2[] = _("Resum");
static const u8 sText_Trade2[] = _("Intercanvi");
static const u8 sText_CommunicationStandby[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}Comunicació en espera…\nSi us plau, espera.");
static const u8 sText_TheTradeHasBeenCanceled[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}L'intercanvi ha estat\ncancel·lat.");
static const u8 sText_OnlyPkmnForBattle[] = _("És el teu únic\nPokémon per combatre.");
static const u8 sText_WaitingForYourFriend[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}Esperant que el teu amic\nacabi…");
static const u8 sText_YourFriendWantsToTrade[] = _("El teu amic vol\nintercanviar Pokémon.");
