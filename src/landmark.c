...
static const u8 LandmarkName_FlowerShop[] = _("Floristeria");
static const u8 LandmarkName_PetalburgWoods[] = _("Bosc Petalburg");
static const u8 LandmarkName_MrBrineysCottage[] = _("Casa del Sr. Briney");
static const u8 LandmarkName_AbandonedShip[] = _("Vaixell Abandonat");
static const u8 LandmarkName_SeashoreHouse[] = _("Casa de la Platja");
static const u8 LandmarkName_SlateportBeach[] = _("Platja Slateport");
static const u8 LandmarkName_CyclingRoad[] = _("Via Ciclista");
static const u8 LandmarkName_NewMauville[] = _("Nova Mauville");
static const u8 LandmarkName_TrickHouse[] = _("Casa Truc");
static const u8 LandmarkName_OldLadysRestShop[] = _("Parada de la Velleta");
static const u8 LandmarkName_Desert[] = _("Desert");
static const u8 LandmarkName_WinstrateFamily[] = _("Família Winstrate");
static const u8 LandmarkName_CableCar[] = _("Telefèric");
static const u8 LandmarkName_GlassWorkshop[] = _("Taller de Vidre");
static const u8 LandmarkName_WeatherInstitute[] = _("Institut del Temps");
static const u8 LandmarkName_MeteorFalls[] = _("Cascada Meteor");
static const u8 LandmarkName_TunnelersRestHouse[] = _("Refugi del Tuneler");
static const u8 LandmarkName_RusturfTunnel[] = _("Túnel Rusturf");
static const u8 LandmarkName_PokemonDayCare[] = _("Guarderia Pokémon");
static const u8 LandmarkName_SafariZoneEntrance[] = _("Entrada Zona Safari");
static const u8 LandmarkName_MtPyre[] = _("Mont Pyre");
static const u8 LandmarkName_ShoalCave[] = _("Cova Shoal");
static const u8 LandmarkName_SeafloorCavern[] = _("Caverna Marina");
static const u8 LandmarkName_GraniteCave[] = _("Cova Granit");
static const u8 LandmarkName_OceanCurrent[] = _("Corrent Oceànic");
static const u8 LandmarkName_LanettesHouse[] = _("Casa de Lanette");
static const u8 LandmarkName_FieryPath[] = _("Camí Ardent");
static const u8 LandmarkName_JaggedPass[] = _("Pas Dentellat");
static const u8 LandmarkName_SkyPillar[] = _("Pilar Celeste");
static const u8 LandmarkName_BerryMastersHouse[] = _("Casa del Mestre Baia");
static const u8 LandmarkName_IslandCave[] = _("Cova de l'Illa");
static const u8 LandmarkName_DesertRuins[] = _("Ruïnes Desert");
static const u8 LandmarkName_ScorchedSlab[] = _("Llosa Cremada");
static const u8 LandmarkName_AncientTomb[] = _("Tomba Antiga");
static const u8 LandmarkName_SealedChamber[] = _("Cambra Segellada");
static const u8 LandmarkName_FossilManiacsHouse[] = _("Casa del Fossilòman");
static const u8 LandmarkName_HuntersHouse[] = _("Casa del Caçador");
static const u8 LandmarkName_MagmaHideout[] = _("Amagatall Magma");
static const u8 LandmarkName_MirageTower[] = _("Torre Miratge");
static const u8 LandmarkName_AlteringCave[] = _("Cova Canviant");
static const u8 LandmarkName_DesertUnderpass[] = _("Pas del Desert");
static const u8 LandmarkName_TrainerHill[] = _("Turó Entrenador");
