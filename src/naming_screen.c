...
void NameRival(void)
{
    ...
    StringCopy(gSaveBlock2Ptr->rivalName, gRivalPresetNames[Random() % NELEMS(gRivalPresetNames)]);
...
static const u8 sText_RivalsName[] = _("Nom del Rival?");
