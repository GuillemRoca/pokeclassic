...
static const u8 sText_PkmnGainedEXP[] = _("{B_BUFF1} ha guanyat{B_BUFF2}\n{B_BUFF3} Punts d'Exp.!\p");
static const u8 sText_EmptyString4[] = _("");
static const u8 sText_ABoosted[] = _(" un bonus de");
static const u8 sText_PkmnGrewToLv[] = _("{B_BUFF1} ha pujat al\nNiv. {B_BUFF2}!{WAIT_SE}\p");
static const u8 sText_PkmnLearnedMove[] = _("{B_BUFF1} ha après\n{B_BUFF2}!{WAIT_SE}\p");
static const u8 sText_TryToLearnMove1[] = _("{B_BUFF1} vol aprendre\n{B_BUFF2}.\p");
static const u8 sText_TryToLearnMove2[] = _("Però {B_BUFF1} no pot\naprendre més de 4 moviments.\p");
static const u8 sText_TryToLearnMove3[] = _("Vols oblidar un moviment\nper fer lloc a {B_BUFF2}?");
static const u8 sText_PkmnForgotMove[] = _("{B_BUFF1} ha oblidat\n{B_BUFF2}.\p");
static const u8 sText_StopLearningMove[] = _("{PAUSE 32}Deixar d'aprendre\n{B_BUFF2}?");
static const u8 sText_DidNotLearnMove[] = _("{B_BUFF1} no ha après\n{B_BUFF2}.\p");
static const u8 sText_UseNextPkmn[] = _("Usar el següent Pokémon?");
static const u8 sText_AttackMissed[] = _("L'atac de\n{B_ATK_NAME_WITH_PREFIX} ha fallat!");
static const u8 sText_PkmnProtectedItself[] = _("{B_DEF_NAME_WITH_PREFIX}\nes va protegir!");
static const u8 sText_AvoidedDamage[] = _("{B_DEF_NAME_WITH_PREFIX} ha evitat\nel dany amb {B_DEF_ABILITY}!");
static const u8 sText_PkmnMakesGroundMiss[] = _("{B_DEF_NAME_WITH_PREFIX} evita atacs\nTerra amb {B_DEF_ABILITY}!");
static const u8 sText_PkmnAvoidedAttack[] = _("{B_DEF_NAME_WITH_PREFIX} ha esquivat\nl'atac!");
static const u8 sText_ItDoesntAffect[] = _("No afecta\n{B_DEF_NAME_WITH_PREFIX}…");
...
#else
static const u8 sText_PlayerWhiteout2[] = _("{B_PLAYER_NAME} va ser derrotat!{PAUSE_UNTIL_PRESS}");
#endif
static const u8 sText_PlayerDroppedMoneyNoWhiteout[] = _("{B_PLAYER_NAME} ha entrat en pànic\ni ha perdut ¥{B_BUFF1}…\p… … … …{PAUSE_UNTIL_PRESS}");
static const u8 sText_PlayerWhiteout3[] = _("{B_PLAYER_NAME} ha perdut el combat!{PAUSE_UNTIL_PRESS}");
static const u8 sText_PreventsEscape[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} impedeix\nfugir amb {B_SCR_ACTIVE_ABILITY}!\p");
static const u8 sText_CantEscape2[] = _("No pots fugir!\p");
static const u8 sText_AttackerCantEscape[] = _("{B_ATK_NAME_WITH_PREFIX} no pot fugir!");
static const u8 sText_HitXTimes[] = _("Ha colpejat {B_BUFF1} cop(s)!");
static const u8 sText_PkmnFellAsleep[] = _("{B_EFF_NAME_WITH_PREFIX}\ns'ha adormit!");
static const u8 sText_PkmnMadeSleep[] = _("{B_SCR_ACTIVE_ABILITY} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX} ha adormit\l{B_EFF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnAlreadyAsleep[] = _("{B_DEF_NAME_WITH_PREFIX} ja\nestà adormit!");
static const u8 sText_PkmnAlreadyAsleep2[] = _("{B_ATK_NAME_WITH_PREFIX} ja\nestà adormit!");
static const u8 sText_PkmnWasntAffected[] = _("{B_DEF_NAME_WITH_PREFIX}\nno es va veure afectat!");
static const u8 sText_PkmnWasPoisoned[] = _("{B_EFF_NAME_WITH_PREFIX}\nha estat enverienat!");
static const u8 sText_PkmnPoisonedBy[] = _("{B_EFF_NAME_WITH_PREFIX} ha estat\nenverienat per {B_BUFF1}\lde {B_SCR_ACTIVE_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnHurtByPoison[] = _("{B_ATK_NAME_WITH_PREFIX} pateix\npel verí!");
static const u8 sText_PkmnAlreadyPoisoned[] = _("{B_DEF_NAME_WITH_PREFIX} ja està\nenverienat.");
static const u8 sText_PkmnBadlyPoisoned[] = _("{B_EFF_NAME_WITH_PREFIX} està\nmolt enverienat!");
static const u8 sText_PkmnEnergyDrained[] = _("L'energia de\n{B_DEF_NAME_WITH_PREFIX} ha estat\labsorbida!");
static const u8 sText_PkmnWasBurned[] = _("{B_EFF_NAME_WITH_PREFIX} s'ha cremat!");
static const u8 sText_PkmnBurnedBy[] = _("{B_SCR_ACTIVE_ABILITY} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX} ha cremat\l{B_EFF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnHurtByBurn[] = _("{B_ATK_NAME_WITH_PREFIX} pateix\nper la cremada!");
static const u8 sText_PkmnAlreadyHasBurn[] = _("{B_DEF_NAME_WITH_PREFIX} ja\nestà cremat.");
static const u8 sText_PkmnWasFrozen[] = _("{B_EFF_NAME_WITH_PREFIX} ha quedat\ngelat!");
static const u8 sText_PkmnFrozenBy[] = _("{B_SCR_ACTIVE_ABILITY} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX} ha gelat\l{B_EFF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnIsFrozen[] = _("{B_ATK_NAME_WITH_PREFIX} està\ngelat!");
static const u8 sText_PkmnWasDefrosted[] = _("{B_DEF_NAME_WITH_PREFIX} s'ha\ndesgelat!");
static const u8 sText_PkmnWasDefrosted2[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha\ndesgelat!");
static const u8 sText_PkmnWasDefrostedBy[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha\ndesgelat amb {B_CURRENT_MOVE}!");
static const u8 sText_PkmnWasParalyzed[] = _("{B_EFF_NAME_WITH_PREFIX} està\nparalitzat! Pot ser que\lno es pugui moure!");
static const u8 sText_PkmnWasParalyzedBy[] = _("{B_SCR_ACTIVE_ABILITY} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX} ha paralitzat\l{B_EFF_NAME_WITH_PREFIX}!\lPot no moure's!");
static const u8 sText_PkmnIsParalyzed[] = _("{B_ATK_NAME_WITH_PREFIX} està\nparalitzat! No es pot moure!");
static const u8 sText_PkmnIsAlreadyParalyzed[] = _("{B_DEF_NAME_WITH_PREFIX} ja\nestà paralitzat!");
static const u8 sText_PkmnHealedParalysis[] = _("{B_DEF_NAME_WITH_PREFIX} s'ha\ncurat de la paràlisi!");
static const u8 sText_PkmnDreamEaten[] = _("El somni de\n{B_DEF_NAME_WITH_PREFIX} va ser devorat!");
static const u8 sText_StatsWontIncrease[] = _("{B_BUFF1} de\n{B_ATK_NAME_WITH_PREFIX} no pujarà més!");
static const u8 sText_StatsWontDecrease[] = _("{B_BUFF1} de\n{B_DEF_NAME_WITH_PREFIX} no baixarà més!");
static const u8 sText_TeamStoppedWorking[] = _("{B_BUFF1} del teu equip\nha deixat de funcionar!");
static const u8 sText_FoeStoppedWorking[] = _("{B_BUFF1} del rival\nha deixat de funcionar!");
static const u8 sText_PkmnIsConfused[] = _("{B_ATK_NAME_WITH_PREFIX} està\nconfós!");
static const u8 sText_PkmnHealedConfusion[] = _("{B_ATK_NAME_WITH_PREFIX} ha superat\nla confusió!");
static const u8 sText_PkmnWasConfused[] = _("{B_EFF_NAME_WITH_PREFIX} s'ha\nconfós!");
static const u8 sText_PkmnAlreadyConfused[] = _("{B_DEF_NAME_WITH_PREFIX} ja\nestà confós!");
static const u8 sText_PkmnFellInLove[] = _("{B_DEF_NAME_WITH_PREFIX}\ns'ha enamorat!");
static const u8 sText_PkmnInLove[] = _("{B_ATK_NAME_WITH_PREFIX} està\nenamorat de\l{B_SCR_ACTIVE_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnImmobilizedByLove[] = _("{B_ATK_NAME_WITH_PREFIX} està\nimmobilitzat per l'amor!");
static const u8 sText_PkmnBlownAway[] = _("{B_DEF_NAME_WITH_PREFIX} ha estat\nbufat lluny!");
static const u8 sText_PkmnChangedType[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha\ntransformat al tipus {B_BUFF1}!");
static const u8 sText_PkmnFlinched[] = _("{B_ATK_NAME_WITH_PREFIX} ha retrocedit!");
static const u8 sText_PkmnRegainedHealth[] = _("{B_DEF_NAME_WITH_PREFIX} ha recuperat\nsalut!");
static const u8 sText_PkmnHPFull[] = _("Els PS de\n{B_DEF_NAME_WITH_PREFIX} estan al màxim!");
...
static const u8 sText_PkmnTookSunlight[] = _("{B_ATK_NAME_WITH_PREFIX} ha absorbit\nllum solar!");
static const u8 sText_PkmnLoweredHead[] = _("{B_ATK_NAME_WITH_PREFIX} ha abaixat\nel cap!");
static const u8 sText_PkmnIsGlowing[] = _("{B_ATK_NAME_WITH_PREFIX} brilla!");
static const u8 sText_PkmnFlewHigh[] = _("{B_ATK_NAME_WITH_PREFIX} ha volat\nben amunt!");
static const u8 sText_PkmnDugHole[] = _("{B_ATK_NAME_WITH_PREFIX} ha excavat!");
static const u8 sText_PkmnHidUnderwater[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha amagat\nsota l'aigua!");
static const u8 sText_PkmnSprangUp[] = _("{B_ATK_NAME_WITH_PREFIX} ha saltat!");
static const u8 sText_PkmnInSnapTrap[] = _("{B_DEF_NAME_WITH_PREFIX} ha quedat\natrapat en una trampa!");
static const u8 sText_PkmnSqueezedByBind[] = _("{B_DEF_NAME_WITH_PREFIX} ha estat\npremsatat per Bind de\l{B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnTrappedInVortex[] = _("{B_DEF_NAME_WITH_PREFIX} ha quedat\natrapat al vòrtex!");
static const u8 sText_PkmnTrappedBySandTomb[] = _("{B_DEF_NAME_WITH_PREFIX} ha quedat\natrapat per Sand Tomb!");
static const u8 sText_PkmnWrappedBy[] = _("{B_DEF_NAME_WITH_PREFIX} ha estat\nembolicat per {B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnClamped[] = _("{B_ATK_NAME_WITH_PREFIX} ha enganxat\n{B_DEF_NAME_WITH_PREFIX}!");
...
static const u8 sText_PkmnProtectedItself2[] = _("{B_ATK_NAME_WITH_PREFIX} es va\nprotegir!");
static const u8 sText_PkmnBuffetedBySandstorm[] = _("{B_ATK_NAME_WITH_PREFIX} pateix\nla tempesta de sorra!");
static const u8 sText_PkmnPeltedByHail[] = _("{B_ATK_NAME_WITH_PREFIX} pateix\nla calamarsa!");
static const u8 sText_PkmnsXWoreOff[] = _("{B_BUFF1} de\n{B_ATK_PREFIX1} s'ha esgotat!");
static const u8 sText_PkmnSeeded[] = _("{B_DEF_NAME_WITH_PREFIX} ha estat sembrat!");
static const u8 sText_PkmnEvadedAttack[] = _("{B_DEF_NAME_WITH_PREFIX} ha esquivat\nl'atac!");
static const u8 sText_PkmnSappedByLeechSeed[] = _("La salut de {B_ATK_NAME_WITH_PREFIX}\nés absorbida per Llavor\lSangonera!");
static const u8 sText_PkmnFastAsleep[] = _("{B_ATK_NAME_WITH_PREFIX} està\nprofundament adormit.");
static const u8 sText_PkmnWokeUp[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha despertat!");
static const u8 sText_PkmnUproarKeptAwake[] = _("Però l'Enrenou de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}\ll'ha mantingut despert!");
static const u8 sText_PkmnWokeUpInUproar[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha\ndespertat amb l'Enrenou!");
static const u8 sText_PkmnCausedUproar[] = _("{B_ATK_NAME_WITH_PREFIX} ha causat\nun Enrenou!");
static const u8 sText_PkmnMakingUproar[] = _("{B_ATK_NAME_WITH_PREFIX} està fent\nun Enrenou!");
static const u8 sText_PkmnCalmedDown[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha calmat.");
static const u8 sText_PkmnCantSleepInUproar[] = _("Però {B_DEF_NAME_WITH_PREFIX} no pot\ndormir amb l'Enrenou!");
static const u8 sText_PkmnStockpiled[] = _("{B_ATK_NAME_WITH_PREFIX} ha acumulat\n{B_BUFF1}!");
static const u8 sText_PkmnCantStockpile[] = _("{B_ATK_NAME_WITH_PREFIX} no pot\nacumular més!");
static const u8 sText_PkmnCantSleepInUproar2[] = _("Però {B_DEF_NAME_WITH_PREFIX} no pot\ndormir amb l'Enrenou!");
static const u8 sText_UproarKeptPkmnAwake[] = _("Però l'Enrenou ha mantingut\n{B_DEF_NAME_WITH_PREFIX} despert!");
static const u8 sText_PkmnStayedAwakeUsing[] = _("{B_DEF_NAME_WITH_PREFIX} s'ha mantingut\ndespert amb {B_DEF_ABILITY}!");
static const u8 sText_PkmnStoringEnergy[] = _("{B_ATK_NAME_WITH_PREFIX} està\nemmagatzemant energia!");
static const u8 sText_PkmnUnleashedEnergy[] = _("{B_ATK_NAME_WITH_PREFIX} ha alliberat\nl'energia!");
static const u8 sText_PkmnFatigueConfusion[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha confós\nper la fatiga!");
static const u8 sText_PlayerPickedUpMoney[] = _("{B_PLAYER_NAME} ha recollit\n¥{B_BUFF1}!\p");
static const u8 sText_PkmnUnaffected[] = _("{B_DEF_NAME_WITH_PREFIX} no es\nveu afectat!");
static const u8 sText_PkmnTransformedInto[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha\ntransformat en {B_BUFF1}!");
static const u8 sText_PkmnMadeSubstitute[] = _("{B_ATK_NAME_WITH_PREFIX} ha creat\nun Substitut!");
static const u8 sText_PkmnHasSubstitute[] = _("{B_ATK_NAME_WITH_PREFIX} ja té\nun Substitut!");
static const u8 sText_SubstituteDamaged[] = _("El Substitut ha rebut el dany\nper {B_DEF_NAME_WITH_PREFIX}!\p");
static const u8 sText_PkmnSubstituteFaded[] = _("El Substitut de\n{B_DEF_NAME_WITH_PREFIX} ha desaparegut!\p");
static const u8 sText_PkmnMustRecharge[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha\nde recarregar!");
static const u8 sText_PkmnRageBuilding[] = _("La Ràbia de\n{B_DEF_NAME_WITH_PREFIX} augmenta!");
static const u8 sText_PkmnMoveWasDisabled[] = _("{B_BUFF1} de\n{B_DEF_NAME_WITH_PREFIX} ha estat\ldesactivat!");
static const u8 sText_PkmnMoveDisabledNoMore[] = _("{B_ATK_NAME_WITH_PREFIX} ja no està\ndesactivat!");
static const u8 sText_PkmnGotEncore[] = _("{B_DEF_NAME_WITH_PREFIX} ha rebut\nun Bis!");
static const u8 sText_PkmnEncoreEnded[] = _("El Bis de\n{B_ATK_NAME_WITH_PREFIX} ha acabat!");
static const u8 sText_PkmnTookAim[] = _("{B_ATK_NAME_WITH_PREFIX} ha apuntat\na {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnSketchedMove[] = _("{B_ATK_NAME_WITH_PREFIX} ha esbossat\n{B_BUFF1}!");
static const u8 sText_PkmnTryingToTakeFoe[] = _("{B_ATK_NAME_WITH_PREFIX} intenta\nemportar-se el rival!");
static const u8 sText_PkmnTookFoe[] = _("{B_DEF_NAME_WITH_PREFIX} s'ha\nemportat {B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnReducedPP[] = _("S'han reduït els PU de {B_BUFF1}\nde {B_DEF_NAME_WITH_PREFIX} en {B_BUFF2}!");
static const u8 sText_PkmnStoleItem[] = _("{B_ATK_NAME_WITH_PREFIX} ha robat\n{B_LAST_ITEM} de {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_TargetCantEscapeNow[] = _("{B_DEF_NAME_WITH_PREFIX} no pot\nfugir ara!");
static const u8 sText_PkmnFellIntoNightmare[] = _("{B_DEF_NAME_WITH_PREFIX} ha caigut\nen un Malson!");
static const u8 sText_PkmnLockedInNightmare[] = _("{B_ATK_NAME_WITH_PREFIX} està atrapat\nen un Malson!");
static const u8 sText_PkmnLaidCurse[] = _("{B_ATK_NAME_WITH_PREFIX} ha sacrificat\nPS i ha llançat una Maledicció\la {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnAfflictedByCurse[] = _("{B_ATK_NAME_WITH_PREFIX} pateix\nla Maledicció!");
static const u8 sText_SpikesScattered[] = _("S'han escampat Trampes\nal costat del rival!");
static const u8 sText_PkmnHurtBySpikes[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} pateix\nles Trampes!");
static const u8 sText_PkmnIdentified[] = _("{B_ATK_NAME_WITH_PREFIX} ha identificat\n{B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnPerishCountFell[] = _("El compte enrere de\n{B_ATK_NAME_WITH_PREFIX} ha baixat\la {B_BUFF1}!");
static const u8 sText_PkmnBracedItself[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha\npreparat!");
static const u8 sText_PkmnEnduredHit[] = _("{B_DEF_NAME_WITH_PREFIX} ha aguantat\nel cop!");
static const u8 sText_MagnitudeStrength[] = _("Magnitud {B_BUFF1}!");
static const u8 sText_PkmnCutHPMaxedAttack[] = _("{B_ATK_NAME_WITH_PREFIX} ha sacrificat\nPS i ha maximitzat l'Atac!");
static const u8 sText_PkmnCopiedStatChanges[] = _("{B_ATK_NAME_WITH_PREFIX} ha copiat\nels canvis de {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnGotFree[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha alliberat\nde {B_BUFF1} de {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnShedLeechSeed[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha\nalliberat de Llavor Sangonera!");
static const u8 sText_PkmnBlewAwaySpikes[] = _("{B_ATK_NAME_WITH_PREFIX} ha bufat\nles Trampes!");
static const u8 sText_PkmnFledFromBattle[] = _("{B_ATK_NAME_WITH_PREFIX} ha fugit\ndel combat!");
static const u8 sText_PkmnForesawAttack[] = _("{B_ATK_NAME_WITH_PREFIX} ha previst\nun atac!");
static const u8 sText_PkmnTookAttack[] = _("{B_DEF_NAME_WITH_PREFIX} ha rebut\nl'atac {B_BUFF1}!");
static const u8 sText_PkmnChoseXAsDestiny[] = _("{B_ATK_NAME_WITH_PREFIX} ha triat\n{B_CURRENT_MOVE} com a destí!");
static const u8 sText_PkmnAttack[] = _("L'atac de {B_BUFF1}!");
static const u8 sText_PkmnCenterAttention[] = _("{B_DEF_NAME_WITH_PREFIX} s'ha convertit\nen el centre d'atenció!");
static const u8 sText_PkmnChargingPower[] = _("{B_ATK_NAME_WITH_PREFIX} ha començat\na carregar poder!");
static const u8 sText_NaturePowerTurnedInto[] = _("Força Natural s'ha convertit\nen {B_CURRENT_MOVE}!");
static const u8 sText_PkmnStatusNormal[] = _("L'estat de\n{B_ATK_NAME_WITH_PREFIX} ha tornat\la la normalitat!");
static const u8 sText_PkmnSubjectedToTorment[] = _("{B_DEF_NAME_WITH_PREFIX} ha estat\nsotmès al Turment!");
static const u8 sText_PkmnTighteningFocus[] = _("{B_ATK_NAME_WITH_PREFIX} està\nconcentrant-se!");
static const u8 sText_PkmnFellForTaunt[] = _("{B_DEF_NAME_WITH_PREFIX} ha caigut\nen la Provocació!");
static const u8 sText_PkmnReadyToHelp[] = _("{B_ATK_NAME_WITH_PREFIX} està preparat\nper ajudar {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnSwitchedItems[] = _("{B_ATK_NAME_WITH_PREFIX} ha intercanviat\nobjectes amb el rival!");
static const u8 sText_PkmnObtainedX[] = _("{B_ATK_NAME_WITH_PREFIX} ha obtingut\n{B_BUFF1}.");
static const u8 sText_PkmnObtainedX2[] = _("{B_DEF_NAME_WITH_PREFIX} ha obtingut\n{B_BUFF2}.");
static const u8 sText_PkmnObtainedXYObtainedZ[] = _("{B_ATK_NAME_WITH_PREFIX} ha obtingut\n{B_BUFF1}.\p{B_DEF_NAME_WITH_PREFIX} ha obtingut\n{B_BUFF2}.");
static const u8 sText_PkmnCopiedFoe[] = _("{B_ATK_NAME_WITH_PREFIX} ha copiat\n{B_DEF_ABILITY} de {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnMadeWish[] = _("{B_ATK_NAME_WITH_PREFIX} ha fet un Desig!");
static const u8 sText_PkmnWishCameTrue[] = _("El Desig de {B_BUFF1}\ns'ha fet realitat!");
static const u8 sText_PkmnPlantedRoots[] = _("{B_ATK_NAME_WITH_PREFIX} ha plantat arrels!");
static const u8 sText_PkmnAbsorbedNutrients[] = _("{B_ATK_NAME_WITH_PREFIX} ha absorbit\nnutrients amb les arrels!");
static const u8 sText_PkmnAnchoredItself[] = _("{B_DEF_NAME_WITH_PREFIX} s'ha ancorat\namb les seves arrels!");
static const u8 sText_PkmnWasMadeDrowsy[] = _("{B_ATK_NAME_WITH_PREFIX} ha fet que\n{B_DEF_NAME_WITH_PREFIX} tingui son!");
static const u8 sText_PkmnKnockedOff[] = _("{B_ATK_NAME_WITH_PREFIX} ha fet caure\n{B_LAST_ITEM} de {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnSwappedAbilities[] = _("{B_ATK_NAME_WITH_PREFIX} ha intercanviat\nhabilitats amb el rival!");
static const u8 sText_PkmnSealedOpponentMove[] = _("{B_ATK_NAME_WITH_PREFIX} ha segellat\nel(s) moviment(s) del rival!");
static const u8 sText_PkmnWantsGrudge[] = _("{B_ATK_NAME_WITH_PREFIX} vol que\nel rival carregui Rancúnia!");
static const u8 sText_PkmnLostPPGrudge[] = _("{B_BUFF1} de {B_ATK_NAME_WITH_PREFIX}\nha perdut tots els PU per\lla Rancúnia!");
static const u8 sText_PkmnShroudedItself[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha cobert\namb {B_CURRENT_MOVE}!");
static const u8 sText_PkmnMoveBounced[] = _("{B_CURRENT_MOVE} de\n{B_ATK_NAME_WITH_PREFIX} ha rebotat\lamb Magic Coat!");
static const u8 sText_PkmnWaitsForTarget[] = _("{B_ATK_NAME_WITH_PREFIX} espera que\nel rival faci un moviment!");
static const u8 sText_PkmnSnatchedMove[] = _("{B_DEF_NAME_WITH_PREFIX} ha robat\nel moviment de\l{B_SCR_ACTIVE_NAME_WITH_PREFIX}!");
static const u8 sText_ElectricityWeakened[] = _("El poder de l'electricitat\ns'ha debilitat!");
static const u8 sText_FireWeakened[] = _("El poder del foc\ns'ha debilitat!");
static const u8 sText_XFoundOneY[] = _("{B_ATK_NAME_WITH_PREFIX} ha trobat\nun {B_LAST_ITEM}!");
static const u8 sText_SoothingAroma[] = _("Un aroma reconfortant\ns'ha escampat per la zona!");
static const u8 sText_ItemsCantBeUsedNow[] = _("No es poden usar objectes ara.{PAUSE 64}");
static const u8 sText_ForXCommaYZ[] = _("Per a {B_SCR_ACTIVE_NAME_WITH_PREFIX},\n{B_LAST_ITEM} {B_BUFF1}");
static const u8 sText_PkmnUsedXToGetPumped[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} ha usat\n{B_LAST_ITEM} per animar-se!");
static const u8 sText_PkmnLostFocus[] = _("{B_ATK_NAME_WITH_PREFIX} ha perdut\nla concentració i no s'ha mogut!");
static const u8 sText_PkmnWasDraggedOut[] = _("{B_DEF_NAME_WITH_PREFIX} ha estat\ntret a la força!\p");
static const u8 sText_TheWallShattered[] = _("El mur s'ha trencat!");
static const u8 sText_ButNoEffect[] = _("Però no ha tingut efecte!");
static const u8 sText_PkmnHasNoMovesLeft[] = _("{B_ACTIVE_NAME_WITH_PREFIX} no té\nmoviments disponibles!\p");
static const u8 sText_PkmnMoveIsDisabled[] = _("{B_CURRENT_MOVE} de\n{B_ACTIVE_NAME_WITH_PREFIX} està\ldesactivat!\p");
static const u8 sText_PkmnCantUseMoveTorment[] = _("{B_ACTIVE_NAME_WITH_PREFIX} no pot usar\nel mateix moviment seguit\lper culpa del Turment!\p");
static const u8 sText_PkmnCantUseMoveTaunt[] = _("{B_ACTIVE_NAME_WITH_PREFIX} no pot usar\n{B_CURRENT_MOVE} per la\lProvocació!\p");
static const u8 sText_PkmnCantUseMoveSealed[] = _("{B_ACTIVE_NAME_WITH_PREFIX} no pot usar\n{B_CURRENT_MOVE} segellat!\p");
static const u8 sText_PkmnCantUseMoveThroatChop[] = _("{B_ACTIVE_NAME_WITH_PREFIX} no pot usar\n{B_CURRENT_MOVE} per Throat Chop!\p");
static const u8 sText_PkmnMadeItRain[] = _("{B_SCR_ACTIVE_ABILITY} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}\lha fet ploure!");
static const u8 sText_PkmnRaisedSpeed[] = _("{B_SCR_ACTIVE_ABILITY} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}\lha pujat la Velocitat!");
static const u8 sText_PkmnProtectedBy[] = _("{B_DEF_NAME_WITH_PREFIX} ha estat\nprotegit per {B_DEF_ABILITY}!");
static const u8 sText_PkmnPreventsUsage[] = _("{B_DEF_ABILITY} de\n{B_DEF_NAME_WITH_PREFIX} impedeix\l{B_ATK_NAME_WITH_PREFIX} usar\l{B_CURRENT_MOVE}!");
static const u8 sText_PkmnRestoredHPUsing[] = _("{B_DEF_NAME_WITH_PREFIX} ha recuperat\nPS amb {B_DEF_ABILITY}!");
static const u8 sText_PkmnsXMadeYUseless[] = _("{B_DEF_ABILITY} de\n{B_DEF_NAME_WITH_PREFIX} ha fet\l{B_CURRENT_MOVE} inútil!");
static const u8 sText_PkmnChangedTypeWith[] = _("{B_DEF_ABILITY} de\n{B_DEF_NAME_WITH_PREFIX} l'ha fet\ldel tipus {B_BUFF1}!");
static const u8 sText_PkmnPreventsParalysisWith[] = _("{B_DEF_ABILITY} de\n{B_EFF_NAME_WITH_PREFIX} impedeix\lla paràlisi!");
static const u8 sText_PkmnPreventsRomanceWith[] = _("{B_DEF_ABILITY} de\n{B_DEF_NAME_WITH_PREFIX} impedeix\nl'enamorament!");
static const u8 sText_PkmnPreventsPoisoningWith[] = _("{B_DEF_ABILITY} de\n{B_EFF_NAME_WITH_PREFIX} impedeix\nl'enverinament!");
static const u8 sText_PkmnPreventsConfusionWith[] = _("{B_DEF_ABILITY} de\n{B_DEF_NAME_WITH_PREFIX} impedeix\nla confusió!");
static const u8 sText_PkmnRaisedFirePowerWith[] = _("{B_DEF_ABILITY} de\n{B_DEF_NAME_WITH_PREFIX} ha pujat\nel poder de Foc!");
static const u8 sText_PkmnAnchorsItselfWith[] = _("{B_DEF_NAME_WITH_PREFIX} s'ancora\namb {B_DEF_ABILITY}!");
static const u8 sText_PkmnCutsAttackWith[] = _("{B_SCR_ACTIVE_ABILITY} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX} redueix\ll'Atac de {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnPreventsStatLossWith[] = _("{B_SCR_ACTIVE_ABILITY} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}\limpedeix la pèrdua d'estad.!");
static const u8 sText_PkmnHurtsWith[] = _("{B_DEF_ABILITY} de\n{B_DEF_NAME_WITH_PREFIX} ha ferit\l{B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnTraced[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} ha copiat\n{B_BUFF2} de {B_BUFF1}!");
static const u8 sText_PkmnsXPreventsBurns[] = _("{B_EFF_ABILITY} de\n{B_EFF_NAME_WITH_PREFIX} impedeix\nles cremades!");
static const u8 sText_PkmnsXBlocksY[] = _("{B_DEF_ABILITY} de\n{B_DEF_NAME_WITH_PREFIX} bloqueja\l{B_CURRENT_MOVE}!");
static const u8 sText_PkmnsXBlocksY2[] = _("{B_SCR_ACTIVE_ABILITY} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}\lbloqueja {B_CURRENT_MOVE}!");
static const u8 sText_PkmnsXRestoredHPALittle2[] = _("{B_ATK_ABILITY} de\n{B_ATK_NAME_WITH_PREFIX} ha recuperat\luna mica de PS!");
static const u8 sText_PkmnsXWhippedUpSandstorm[] = _("{B_SCR_ACTIVE_ABILITY} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}\lha creat una tempesta de sorra!");
static const u8 sText_PkmnsXIntensifiedSun[] = _("{B_SCR_ACTIVE_ABILITY} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}\lha intensificat el sol!");
static const u8 sText_PkmnsXPreventsYLoss[] = _("{B_SCR_ACTIVE_ABILITY} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}\limpedeix la pèrdua de {B_BUFF1}!");
static const u8 sText_PkmnsXInfatuatedY[] = _("{B_DEF_ABILITY} de\n{B_DEF_NAME_WITH_PREFIX} ha enamorat\l{B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnsXMadeYIneffective[] = _("{B_DEF_ABILITY} de\n{B_DEF_NAME_WITH_PREFIX} ha fet\l{B_CURRENT_MOVE} inefectiu!");
static const u8 sText_PkmnsXCuredYProblem[] = _("{B_SCR_ACTIVE_ABILITY} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}\lha curat el problema de {B_BUFF1}!");
static const u8 sText_ItSuckedLiquidOoze[] = _("Ha absorbit el\nLiquid Ooze!");
static const u8 sText_PkmnTransformed[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} s'ha transformat!");
static const u8 sText_PkmnsXTookAttack[] = _("{B_DEF_ABILITY} de\n{B_DEF_NAME_WITH_PREFIX} ha rebut\ll'atac!");
const u8 gText_PkmnsXPreventsSwitching[] = _("{B_LAST_ABILITY} de {B_BUFF1}\nimpedeix el canvi!\p");
static const u8 sText_PreventedFromWorking[] = _("{B_DEF_ABILITY} de\n{B_DEF_NAME_WITH_PREFIX} ha impedit\l{B_BUFF1} de {B_SCR_ACTIVE_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnsXMadeItIneffective[] = _("{B_SCR_ACTIVE_ABILITY} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}\ll'ha fet inefectiu!");
static const u8 sText_PkmnsXPreventsFlinching[] = _("{B_EFF_ABILITY} de\n{B_EFF_NAME_WITH_PREFIX} impedeix\nel retrocés!");
...
static const u8 sText_OneHitKO[] = _("K.O. d'un sol cop!");
static const u8 sText_123Poof[] = _("{PAUSE 32}1, {PAUSE 15}2, i{PAUSE 15}… {PAUSE 15}… {PAUSE 15}… {PAUSE 15}{PLAY_SE SE_BALL_BOUNCE_1}Puf!\p");
static const u8 sText_AndEllipsis[] = _("I…\p");
static const u8 sText_HMMovesCantBeForgotten[] = _("Els moviments de MO no es\npoden oblidar ara.\p");
static const u8 sText_NotVeryEffective[] = _("No és gaire efectiu…");
static const u8 sText_SuperEffective[] = _("És molt efectiu!");
static const u8 sText_GotAwaySafely[] = _("{PLAY_SE SE_FLEE}Has fugit amb èxit!\p");
static const u8 sText_PkmnFledUsingIts[] = _("{PLAY_SE SE_FLEE}{B_ATK_NAME_WITH_PREFIX} ha fugit\namb {B_LAST_ITEM}!\p");
static const u8 sText_PkmnFledUsing[] = _("{PLAY_SE SE_FLEE}{B_ATK_NAME_WITH_PREFIX} ha fugit\namb {B_ATK_ABILITY}!\p");
static const u8 sText_WildPkmnFled[] = _("{PLAY_SE SE_FLEE}{B_BUFF1} salvatge ha fugit!");
static const u8 sText_PlayerDefeatedLinkTrainer[] = _("El jugador ha derrotat\n{B_LINK_OPPONENT1_NAME}!");
static const u8 sText_TwoLinkTrainersDefeated[] = _("El jugador ha vençut\n{B_LINK_OPPONENT1_NAME}\li {B_LINK_OPPONENT2_NAME}!");
static const u8 sText_PlayerLostAgainstLinkTrainer[] = _("El jugador ha perdut contra\n{B_LINK_OPPONENT1_NAME}!");
static const u8 sText_PlayerLostToTwo[] = _("El jugador ha perdut contra\n{B_LINK_OPPONENT1_NAME}\li {B_LINK_OPPONENT2_NAME}!");
static const u8 sText_PlayerBattledToDrawLinkTrainer[] = _("El jugador ha empatat contra\n{B_LINK_OPPONENT1_NAME}!");
static const u8 sText_PlayerBattledToDrawVsTwo[] = _("El jugador ha empatat contra\n{B_LINK_OPPONENT1_NAME} i {B_LINK_OPPONENT2_NAME}!");
static const u8 sText_WildFled[] = _("{PLAY_SE SE_FLEE}{B_LINK_OPPONENT1_NAME} ha fugit!");
static const u8 sText_TwoWildFled[] = _("{PLAY_SE SE_FLEE}{B_LINK_OPPONENT1_NAME} i\n{B_LINK_OPPONENT2_NAME} han fugit!");
static const u8 sText_NoRunningFromTrainers[] = _("No! No pots fugir d'un\ncombat d'Entrenador!\p");
static const u8 sText_CantEscape[] = _("No pots fugir!\p");
static const u8 sText_DontLeaveBirch[] = _("Prof. Oak: No em deixis així!\p");
static const u8 sText_ButNothingHappened[] = _("Però no ha passat res!");
static const u8 sText_ButItFailed[] = _("Però ha fallat!");
static const u8 sText_ItHurtConfusion[] = _("S'ha fet mal a si mateix\nper la confusió!");
static const u8 sText_MirrorMoveFailed[] = _("El Moviment Mirall ha fallat!");
static const u8 sText_StartedToRain[] = _("Ha començat a ploure!");
static const u8 sText_DownpourStarted[] = _("Ha començat un xàfec!"); // corresponds to DownpourText in pokegold and pokecrystal and is used by Rain Dance in GSC
static const u8 sText_RainContinues[] = _("La pluja continua caient.");
static const u8 sText_DownpourContinues[] = _("El xàfec continua."); // unused
static const u8 sText_RainStopped[] = _("La pluja s'ha aturat.");
static const u8 sText_SandstormBrewed[] = _("S'ha format una tempesta de sorra!");
static const u8 sText_SandstormRages[] = _("La tempesta de sorra continua.");
static const u8 sText_SandstormSubsided[] = _("La tempesta de sorra ha parat.");
static const u8 sText_SunlightGotBright[] = _("La llum solar s'ha intensificat!");
static const u8 sText_SunlightStrong[] = _("La llum solar és intensa.");
static const u8 sText_SunlightFaded[] = _("La llum solar s'ha esvaït.");
static const u8 sText_StartedHail[] = _("Ha començat a caure calamarsa!");
static const u8 sText_HailContinues[] = _("La calamarsa continua caient.");
static const u8 sText_HailStopped[] = _("La calamarsa s'ha aturat.");
static const u8 sText_FailedToSpitUp[] = _("Però no ha pogut\nEscupir res!");
static const u8 sText_FailedToSwallow[] = _("Però no ha pogut\nEmpassar res!");
static const u8 sText_WindBecameHeatWave[] = _("El vent s'ha convertit en\nuna Onada de Calor!");
static const u8 sText_StatChangesGone[] = _("Tots els canvis d'estad.\nhan estat eliminats!");
static const u8 sText_CoinsScattered[] = _("Monedes han caigut pertot!");
static const u8 sText_TooWeakForSubstitute[] = _("Era massa feble per crear\nun Substitut!");
static const u8 sText_SharedPain[] = _("Els lluitadors han compartit\nel seu dolor!");
static const u8 sText_BellChimed[] = _("Ha sonat una campana!");
static const u8 sText_FaintInThree[] = _("Tots els Pokémon afectats\nes desmaiaran en tres torns!");
static const u8 sText_NoPPLeft[] = _("No queden PU per a\naquest moviment!\p");
static const u8 sText_ButNoPPLeft[] = _("Però no quedaven PU\nper al moviment!");
static const u8 sText_PkmnIgnoresAsleep[] = _("{B_ATK_NAME_WITH_PREFIX} ha ignorat\nordres mentre dormia!");
static const u8 sText_PkmnIgnoredOrders[] = _("{B_ATK_NAME_WITH_PREFIX} ha ignorat\nordres!");
static const u8 sText_PkmnBeganToNap[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha posat a dormir!");
static const u8 sText_PkmnLoafing[] = _("{B_ATK_NAME_WITH_PREFIX} està\nfent el dropo!");
static const u8 sText_PkmnWontObey[] = _("{B_ATK_NAME_WITH_PREFIX} no vol\nobeir!");
static const u8 sText_PkmnTurnedAway[] = _("{B_ATK_NAME_WITH_PREFIX} ha girat el cap!");
static const u8 sText_PkmnPretendNotNotice[] = _("{B_ATK_NAME_WITH_PREFIX} ha fet veure\nque no se n'adonava!");
static const u8 sText_EnemyAboutToSwitchPkmn[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME}\nenviarà {B_BUFF2}.\pVols canviar de\nPokémon, {B_PLAYER_NAME}?");
static const u8 sText_PkmnLearnedMove2[] = _("{B_ATK_NAME_WITH_PREFIX} ha après\n{B_BUFF1}!");
static const u8 sText_PlayerDefeatedLinkTrainerTrainer1[] = _("El jugador ha derrotat\n{B_TRAINER1_CLASS} {B_TRAINER1_NAME}!\p");
static const u8 sText_CreptCloser[] = _("{B_PLAYER_NAME} s'ha acostat a\n{B_OPPONENT_MON1_NAME}!");
static const u8 sText_CantGetCloser[] = _("{B_PLAYER_NAME} no pot acostar-se més!");
static const u8 sText_PkmnWatchingCarefully[] = _("{B_OPPONENT_MON1_NAME} observa\namb atenció!");
static const u8 sText_PkmnCuriousAboutX[] = _("{B_OPPONENT_MON1_NAME} té curiositat\nper {B_BUFF1}!");
static const u8 sText_PkmnEnthralledByX[] = _("{B_OPPONENT_MON1_NAME} està fascinat\nper {B_BUFF1}!");
static const u8 sText_PkmnIgnoredX[] = _("{B_OPPONENT_MON1_NAME} ha ignorat\ncompletament {B_BUFF1}!");
static const u8 sText_ThrewPokeblockAtPkmn[] = _("{B_PLAYER_NAME} ha llançat un {POKEBLOCK}\na {B_OPPONENT_MON1_NAME}!");
static const u8 sText_OutOfSafariBalls[] = _("{PLAY_SE SE_DING_DONG}Locutor: No et queden\nSafari Balls! Fi del joc!\p");
static const u8 sText_OpponentMon1Appeared[] = _("{B_OPPONENT_MON1_NAME} ha aparegut!\p");
static const u8 sText_WildPkmnAppeared[] = _("Ha aparegut un {B_OPPONENT_MON1_NAME}\nsalvatge!\p");
static const u8 sText_LegendaryPkmnAppeared[] = _("Ha aparegut un {B_OPPONENT_MON1_NAME}\nsalvatge!\p");
static const u8 sText_WildPkmnAppearedPause[] = _("Ha aparegut un {B_OPPONENT_MON1_NAME}\nsalvatge!{PAUSE 127}");
static const u8 sText_TwoWildPkmnAppeared[] = _("Han aparegut {B_OPPONENT_MON1_NAME}\ni {B_OPPONENT_MON2_NAME} salvatges!\p");
static const u8 sText_Trainer1WantsToBattle[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME}\nvol combatre!\p");
static const u8 sText_LinkTrainerWantsToBattle[] = _("{B_LINK_OPPONENT1_NAME}\nvol combatre!");
static const u8 sText_TwoLinkTrainersWantToBattle[] = _("{B_LINK_OPPONENT1_NAME} i {B_LINK_OPPONENT2_NAME}\nvolen combatre!");
static const u8 sText_Trainer1SentOutPkmn[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME}\nha enviat {B_OPPONENT_MON1_NAME}!");
static const u8 sText_Trainer1SentOutTwoPkmn[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME}\nha enviat {B_OPPONENT_MON1_NAME}\li {B_OPPONENT_MON2_NAME}!");
static const u8 sText_Trainer1SentOutPkmn2[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME}\nha enviat {B_BUFF1}!");
static const u8 sText_LinkTrainerSentOutPkmn[] = _("{B_LINK_OPPONENT1_NAME} ha enviat\n{B_OPPONENT_MON1_NAME}!");
static const u8 sText_LinkTrainerSentOutTwoPkmn[] = _("{B_LINK_OPPONENT1_NAME} ha enviat\n{B_OPPONENT_MON1_NAME} i {B_OPPONENT_MON2_NAME}!");
static const u8 sText_TwoLinkTrainersSentOutPkmn[] = _("{B_LINK_OPPONENT1_NAME} ha enviat {B_LINK_OPPONENT_MON1_NAME}!\n{B_LINK_OPPONENT2_NAME} ha enviat {B_LINK_OPPONENT_MON2_NAME}!");
static const u8 sText_LinkTrainerSentOutPkmn2[] = _("{B_LINK_OPPONENT1_NAME} ha enviat\n{B_BUFF1}!");
static const u8 sText_LinkTrainerMultiSentOutPkmn[] = _("{B_LINK_SCR_TRAINER_NAME} ha enviat\n{B_BUFF1}!");
static const u8 sText_GoPkmn[] = _("Endavant, {B_PLAYER_MON1_NAME}!");
static const u8 sText_GoTwoPkmn[] = _("Endavant, {B_PLAYER_MON1_NAME}\ni {B_PLAYER_MON2_NAME}!");
static const u8 sText_GoPkmn2[] = _("Endavant, {B_BUFF1}!");
static const u8 sText_DoItPkmn[] = _("Fes-ho, {B_BUFF1}!");
static const u8 sText_GoForItPkmn[] = _("A per ells, {B_BUFF1}!");
static const u8 sText_YourFoesWeakGetEmPkmn[] = _("El rival és feble!\nEndavant, {B_BUFF1}!");
static const u8 sText_LinkPartnerSentOutPkmnGoPkmn[] = _("{B_LINK_PARTNER_NAME} ha enviat {B_LINK_PLAYER_MON2_NAME}!\nEndavant, {B_LINK_PLAYER_MON1_NAME}!");
static const u8 sText_PkmnThatsEnough[] = _("{B_BUFF1}, ja n'hi ha prou!\nTorna!");
static const u8 sText_PkmnComeBack[] = _("{B_BUFF1}, torna!");
static const u8 sText_PkmnOkComeBack[] = _("{B_BUFF1}, bé!\nTorna!");
static const u8 sText_PkmnGoodComeBack[] = _("{B_BUFF1}, molt bé!\nTorna!");
...
static const u8 sText_Speed[] = _("Velocitat");
static const u8 sText_SpAtk2[] = _("Atac Esp.");
static const u8 sText_SpDef2[] = _("Def. Esp.");

static const u8 sText_Accuracy[] = _("precisió");
static const u8 sText_Evasiveness[] = _("esquiva");
...
static const u8 sText_PokeblockWasTooSpicy[] = _("era massa picant!");
static const u8 sText_PokeblockWasTooDry[] = _("era massa sec!");
static const u8 sText_PokeblockWasTooSweet[] = _("era massa dolç!");
static const u8 sText_PokeblockWasTooBitter[] = _("era massa amarg!");
static const u8 sText_PokeblockWasTooSour[] = _("era massa àcid!");
...
static const u8 sText_PlayerUsedItem[] = _("{B_PLAYER_NAME} ha usat\n{B_LAST_ITEM}!");
static const u8 sText_WallyUsedItem[] = _("El Professor Oak ha usat\n{B_LAST_ITEM}!");
static const u8 sText_Trainer1UsedItem[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME}\nha usat {B_LAST_ITEM}!");
static const u8 sText_TrainerBlockedBall[] = _("L'Entrenador ha bloquejat la Ball!");
static const u8 sText_DontBeAThief[] = _("No siguis un lladre!");
static const u8 sText_ItDodgedBall[] = _("Ha esquivat la Ball llançada!\nAquest Pokémon no es pot atrapar!");
static const u8 sText_YouMissedPkmn[] = _("Has fallat el Pokémon!");
static const u8 sText_PkmnBrokeFree[] = _("Oh, no!\nEl Pokémon s'ha escapat!");
static const u8 sText_ItAppearedCaught[] = _("Oh!\nSemblava que l'havies atrapat!");
static const u8 sText_AarghAlmostHadIt[] = _("Argh!\nQuasi l'atrapaves!");
static const u8 sText_ShootSoClose[] = _("Llàstima!\nHi estaves tan a prop!");
static const u8 sText_GotchaPkmnCaught[] = _("Atrapat!\nHas capturat {B_DEF_NAME}!{WAIT_SE}{PLAY_BGM MUS_CAUGHT}\p");
static const u8 sText_GotchaPkmnCaught2[] = _("Atrapat!\nHas capturat {B_DEF_NAME}!{WAIT_SE}{PLAY_BGM MUS_CAUGHT}{PAUSE 127}");
static const u8 sText_GiveNicknameCaptured[] = _("Vols posar un malnom al\n{B_DEF_NAME} capturat?");
static const u8 sText_PkmnSentToPC[] = _("{B_DEF_NAME} ha estat enviat al\nPC {B_PC_CREATOR_NAME}.");
static const u8 sText_Someones[] = _("d'algú");
static const u8 sText_Lanettes[] = _("de Bill");
static const u8 sText_PkmnDataAddedToDex[] = _("Les dades de {B_OPPONENT_MON1_NAME}\ns'han afegit a la Pokédex.\p");
static const u8 sText_ItIsRaining[] = _("Està plovent.");
static const u8 sText_SandstormIsRaging[] = _("Hi ha una tempesta de sorra.");
static const u8 sText_BoxIsFull[] = _("La caixa és plena!\nNo pots atrapar-ne més!\p");
static const u8 sText_EnigmaBerry[] = _("Baia Enigma");
static const u8 sText_BerrySuffix[] = _(" Baia");
static const u8 sText_PkmnsItemCuredParalysis[] = _("{B_LAST_ITEM} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}\lha curat la paràlisi!");
static const u8 sText_PkmnsItemCuredPoison[] = _("{B_LAST_ITEM} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}\lha curat el verí!");
static const u8 sText_PkmnsItemHealedBurn[] = _("{B_LAST_ITEM} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}\lha curat la cremada!");
static const u8 sText_PkmnsItemDefrostedIt[] = _("{B_LAST_ITEM} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}\ll'ha desgelat!");
static const u8 sText_PkmnsItemWokeIt[] = _("{B_LAST_ITEM} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}\ll'ha despertat!");
static const u8 sText_PkmnsItemSnappedOut[] = _("{B_LAST_ITEM} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}\nl'ha tret de la confusió!");
static const u8 sText_PkmnsItemCuredProblem[] = _("{B_LAST_ITEM} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}\lha curat el problema de {B_BUFF1}!");
static const u8 sText_PkmnsItemNormalizedStatus[] = _("{B_LAST_ITEM} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}\lha normalitzat el seu estat!");
static const u8 sText_PkmnsItemRestoredHealth[] = _("{B_LAST_ITEM} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}\lha restaurat salut!");
static const u8 sText_PkmnsItemRestoredPP[] = _("{B_LAST_ITEM} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}\lha restaurat PU de {B_BUFF1}!");
static const u8 sText_PkmnsItemRestoredStatus[] = _("{B_LAST_ITEM} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}\lha restaurat el seu estat!");
static const u8 sText_PkmnsItemRestoredHPALittle[] = _("{B_LAST_ITEM} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}\lha recuperat una mica de PS!");
static const u8 sText_ItemAllowsOnlyYMove[] = _("{B_LAST_ITEM} només permet\nusar {B_CURRENT_MOVE}!\p");
static const u8 sText_PkmnHungOnWithX[] = _("{B_DEF_NAME_WITH_PREFIX} ha aguantat\namb {B_LAST_ITEM}!");
const u8 gText_EmptyString3[] = _("");
static const u8 sText_YouThrowABallNowRight[] = _("Para atenció, {B_PLAYER_NAME}.\nAixí és com captures un Pokémon!");
...
// New battle strings.
static const s8 sText_EnduredViaSturdy[] = _("{B_DEF_NAME_WITH_PREFIX} ha aguantat\nel cop amb {B_DEF_ABILITY}!");
static const s8 sText_PowerHerbActivation[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha carregat\ncompletament amb {B_LAST_ITEM}!");
static const s8 sText_HurtByItem[] = _("{B_ATK_NAME_WITH_PREFIX} ha rebut dany\nde {B_LAST_ITEM}!");
static const s8 sText_BadlyPoisonedByItem[] = _("{B_EFF_NAME_WITH_PREFIX} ha quedat molt\nenverienat per {B_LAST_ITEM}!");
static const s8 sText_BurnedByItem[] = _("{B_EFF_NAME_WITH_PREFIX} s'ha cremat\nper {B_LAST_ITEM}!");
static const s8 sText_TargetAbilityActivates[] = _("{B_DEF_ABILITY} de {B_DEF_NAME_WITH_PREFIX} s'activa!");
static const u8 sText_GravityIntensified[] = _("La gravetat s'ha intensificat!");
static const u8 sText_TargetIdentified[] = _("{B_DEF_NAME_WITH_PREFIX} ha estat\nidentificat!");
static const u8 sText_TargetWokeUp[] = _("{B_DEF_NAME_WITH_PREFIX} s'ha despertat!");
static const u8 sText_PkmnStoleAndAteItem[] = _("{B_ATK_NAME_WITH_PREFIX} ha robat i\nmenjat {B_LAST_ITEM} de\l{B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_TailWindBlew[] = _("El vent de cua ha bufat\ndarrere l'equip {B_ATK_TEAM2}!");
static const u8 sText_PkmnWentBack[] = _("{B_ATK_NAME_WITH_PREFIX} ha tornat\namb {B_ATK_TRAINER_CLASS} {B_ATK_TRAINER_NAME}");
static const u8 sText_PkmnCantUseItemsAnymore[] = _("{B_DEF_NAME_WITH_PREFIX} ja no pot\nusar objectes!");
static const u8 sText_PkmnFlung[] = _("{B_ATK_NAME_WITH_PREFIX} ha llançat\n{B_LAST_ITEM}!");
static const u8 sText_PkmnPreventedFromHealing[] = _("S'ha impedit que\n{B_DEF_NAME_WITH_PREFIX} es curi!");
static const u8 sText_PkmnSwitchedAtkAndDef[] = _("{B_ATK_NAME_WITH_PREFIX} ha intercanviat\nel seu Atac i Defensa!");
static const u8 sText_PkmnsAbilitySuppressed[] = _("L'habilitat de\n{B_DEF_NAME_WITH_PREFIX} ha estat\lsuprimida!");
static const u8 sText_ShieldedFromCriticalHits[] = _("{B_CURRENT_MOVE} ha protegit l'equip\n{B_ATK_TEAM2} dels cops crítics!");
static const u8 sText_SwitchedAtkAndSpAtk[] = _("{B_ATK_NAME_WITH_PREFIX} ha intercanviat\nels canvis d'Atac i\pAtac Esp. amb l'objectiu!");
static const u8 sText_SwitchedDefAndSpDef[] = _("{B_ATK_NAME_WITH_PREFIX} ha intercanviat\nels canvis de Defensa i\pDef. Esp. amb l'objectiu!");
static const u8 sText_PkmnAcquiredAbility[] = _("{B_DEF_NAME_WITH_PREFIX} ha adquirit\n{B_DEF_ABILITY}!");
static const u8 sText_PoisonSpikesScattered[] = _("S'han escampat Trampes Tòxiques\nal voltant de l'equip rival!");
static const u8 sText_PkmnSwitchedStatChanges[] = _("{B_ATK_NAME_WITH_PREFIX} ha intercanviat\nels canvis d'estad. amb\ll'objectiu!");
static const u8 sText_PkmnSurroundedWithVeilOfWater[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha envoltat\namb un vel d'aigua!");
static const u8 sText_PkmnLevitatedOnElectromagnetism[] = _("{B_ATK_NAME_WITH_PREFIX} ha levitat\namb electromagnetisme!");
static const u8 sText_PkmnTwistedDimensions[] = _("{B_ATK_NAME_WITH_PREFIX} ha torçat\nles dimensions!");
static const u8 sText_PointedStonesFloat[] =_("Pedres esmolades floten a l'aire\nal voltant de l'equip {B_DEF_TEAM2}!");
static const u8 sText_CloakedInMysticalMoonlight[] =_("S'ha cobert amb una llum\nde lluna mística!");
static const u8 sText_TrappedBySwirlingMagma[] =_("{B_DEF_NAME_WITH_PREFIX} ha quedat\natrapat per magma remolí!");
static const u8 sText_VanishedInstantly[] =_("{B_ATK_NAME_WITH_PREFIX} ha desaparegut\nal moment!");
static const u8 sText_ProtectedTeam[] =_("{B_CURRENT_MOVE} ha protegit\nl'equip {B_ATK_TEAM2}!");
static const u8 sText_SharedItsGuard[] =_("{B_ATK_NAME_WITH_PREFIX} ha compartit\nla guàrdia amb l'objectiu!");
static const u8 sText_SharedItsPower[] =_("{B_ATK_NAME_WITH_PREFIX} ha compartit\nel poder amb l'objectiu!");
static const u8 sText_SwapsDefAndSpDefOfAllPkmn[] =_("S'ha creat una zona estranya on\nDefensa i Def. Esp. s'intercanvien!");
static const u8 sText_BecameNimble[] =_("{B_ATK_NAME_WITH_PREFIX} s'ha tornat àgil!");
static const u8 sText_HurledIntoTheAir[] =_("{B_DEF_NAME_WITH_PREFIX} ha estat\nllançat enlaire!");
static const u8 sText_HeldItemsLoseEffects[] =_("S'ha creat una zona estranya on\nels objectes perden el seu efecte!");
static const u8 sText_FellStraightDown[] =_("{B_DEF_NAME_WITH_PREFIX} ha caigut\nen picat!");
static const u8 sText_TargetChangedType[] =_("{B_DEF_NAME_WITH_PREFIX} s'ha\ntransformat al tipus {B_BUFF1}!");
static const u8 sText_PkmnAcquiredSimple[] =_("{B_DEF_NAME_WITH_PREFIX} ha adquirit\nSimple!");
static const u8 sText_KindOffer[] =_("{B_DEF_NAME_WITH_PREFIX}\nha acceptat l'oferta amable!");
static const u8 sText_ResetsTargetsStatLevels[] =_("Els canvis d'estad. de\n{B_DEF_NAME_WITH_PREFIX} s'han eliminat!");
static const u8 sText_AllySwitchPosition[] =_("{B_ATK_NAME_WITH_PREFIX} i\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}\lhan intercanviat posicions!");
static const u8 sText_RestoreTargetsHealth[] =_("Els PS de {B_DEF_NAME_WITH_PREFIX}\nhan estat restaurats!");
static const u8 sText_TookPkmnIntoTheSky[] =_("{B_ATK_NAME_WITH_PREFIX} ha portat\n{B_DEF_NAME_WITH_PREFIX} al cel!");
static const u8 sText_FreedFromSkyDrop[] =_("{B_DEF_NAME_WITH_PREFIX} s'ha alliberat\nde la caiguda del cel!");
static const u8 sText_PostponeTargetMove[] =_("El moviment de\n{B_DEF_NAME_WITH_PREFIX} s'ha ajornat!");
static const u8 sText_ReflectTargetsType[] =_("El tipus de {B_ATK_NAME_WITH_PREFIX}\nha canviat per coincidir amb\lel de {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_TransferHeldItem[] =_("{B_DEF_NAME_WITH_PREFIX} ha rebut\n{B_LAST_ITEM} de {B_ATK_NAME_WITH_PREFIX}");
static const u8 sText_EmbargoEnds[] = _("{B_ATK_NAME_WITH_PREFIX} pot tornar\na usar objectes!");
static const u8 sText_Electromagnetism[] = _("electromagnetisme");
static const u8 sText_BufferEnds[] = _("{B_BUFF1} de\n{B_ATK_NAME_WITH_PREFIX} s'ha esgotat!");
static const u8 sText_ThroatChopEnds[] = _("{B_ATK_NAME_WITH_PREFIX} pot tornar\na usar moviments de so!");
static const u8 sText_TelekinesisEnds[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha alliberat\nde la telecinesi!");
static const u8 sText_TailwindEnds[] = _("El vent de cua de l'equip\n{B_ATK_TEAM1} s'ha esgotat!");
static const u8 sText_LuckyChantEnds[] = _("L'Encant de Sort de l'equip\n{B_ATK_TEAM1} s'ha esgotat!");
static const u8 sText_TrickRoomEnds[] = _("Les dimensions torçades han\ntornat a la normalitat!");
static const u8 sText_WonderRoomEnds[] = _("Wonder Room s'ha acabat. Defensa\ni Def. Esp. tornen a la normalitat!");
static const u8 sText_MagicRoomEnds[] = _("Magic Room s'ha acabat. Els\nobjectes tornen a fer efecte!");
static const u8 sText_MudSportEnds[] = _("L'efecte de Mud Sport s'ha esvaït.");
static const u8 sText_WaterSportEnds[] = _("L'efecte de Water Sport s'ha esvaït.");
static const u8 sText_GravityEnds[] = _("La gravetat ha tornat a la normalitat!");
static const u8 sText_AquaRingHeal[] = _("Aqua Ring ha restaurat\nels PS de {B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_TargetAbilityRaisedStat[] = _("{B_DEF_ABILITY} de\n{B_DEF_NAME_WITH_PREFIX} ha pujat\l{B_BUFF1}!");
static const u8 sText_TargetAbilityLoweredStat[] = _("{B_DEF_ABILITY} de\n{B_DEF_NAME_WITH_PREFIX} ha baixat\l{B_BUFF1}!");
static const u8 sText_AttackerAbilityRaisedStat[] = _("{B_ATK_ABILITY} de\n{B_ATK_NAME_WITH_PREFIX} ha pujat\l{B_BUFF1}!");
static const u8 sText_ScriptingAbilityRaisedStat[] = _("{B_SCR_ACTIVE_ABILITY} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}\lha pujat {B_BUFF1}!");
static const u8 sText_AuroraVeilEnds[] = _("{B_DEF_ABILITY} de\n{B_DEF_NAME_WITH_PREFIX} s'ha esgotat!");
static const u8 sText_ElectricTerrainEnds[] = _("L'electricitat ha desaparegut\ndel camp de batalla.");
static const u8 sText_MistyTerrainEnds[] = _("La boira ha desaparegut\ndel camp de batalla.");
static const u8 sText_PsychicTerrainEnds[] = _("L'estranyesa ha desaparegut\ndel camp de batalla.");
static const u8 sText_GrassyTerrainEnds[] = _("L'herba ha desaparegut\ndel camp de batalla.");
static const u8 sText_TargetsStatWasMaxedOut[] = _("{B_DEF_ABILITY} de\n{B_DEF_NAME_WITH_PREFIX} ha maximitzat\l{B_BUFF1}!");
static const u8 sText_PoisonHealHpUp[] = _("El verí ha curat una mica\n{B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_BadDreamsDmg[] = _("{B_DEF_NAME_WITH_PREFIX} és turmentat\nper {B_ATK_ABILITY}!");
static const u8 sText_MoldBreakerEnters[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} trenca el motlle!");
...
static const u8 sText_SlowStartEnters[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} no s'acaba d'arrencar!");
static const u8 sText_SlowStartEnd[] = _("{B_ATK_NAME_WITH_PREFIX} per fi\ns'ha posat en marxa!");
static const u8 sText_SolarPowerHpDrop[] = _("{B_ATK_ABILITY} de\n{B_ATK_NAME_WITH_PREFIX} cobra el\lseu preu!");
static const u8 sText_AftermathDmg[] = _("{B_ATK_NAME_WITH_PREFIX} ha rebut dany!");
static const u8 sText_AnticipationActivates[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} ha tremolat\nd'anticipació!");
static const u8 sText_ForewarnActivates[] = _("{B_SCR_ACTIVE_ABILITY} ha alertat\n{B_SCR_ACTIVE_NAME_WITH_PREFIX} de\l{B_BUFF1} de {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_IceBodyHpGain[] = _("{B_ATK_ABILITY} de\n{B_ATK_NAME_WITH_PREFIX} l'ha curat\luna mica!");
static const u8 sText_SnowWarningHail[] = _("Ha començat a caure calamarsa!");
static const u8 sText_FriskActivates[] = _("{B_ATK_NAME_WITH_PREFIX} ha escorcollat\n{B_DEF_NAME_WITH_PREFIX} i ha trobat\l{B_LAST_ITEM}!");
static const u8 sText_UnnerveEnters[] = _("L'equip rival està massa\nnerviós per menjar Baies!");
static const u8 sText_HarvestBerry[] = _("{B_ATK_NAME_WITH_PREFIX} ha collit\n{B_LAST_ITEM}!");
static const u8 sText_LastAbilityRaisedBuff1[] = _("{B_LAST_ABILITY} de\n{B_ATK_NAME_WITH_PREFIX} ha pujat\l{B_BUFF1}!");
static const u8 sText_MagicBounceActivates[] = _("{B_DEF_NAME_WITH_PREFIX} ha rebotat\n{B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_ProteanTypeChange[] = _("{B_ATK_ABILITY} de\n{B_ATK_NAME_WITH_PREFIX} l'ha\ltransformat al tipus {B_BUFF1}!");
static const u8 sText_SymbiosisItemPass[] = _("{B_ATK_NAME_WITH_PREFIX} ha passat\n{B_LAST_ITEM} a\l{B_SCR_ACTIVE_NAME_WITH_PREFIX}\lamb {B_ATK_ABILITY}!");
static const u8 sText_StealthRockDmg[] = _("Les pedres esmolades han colpejat\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}!");
static const u8 sText_ToxicSpikesAbsorbed[] = _("Les Trampes Tòxiques han\ndesaparegut dels peus del rival!");
static const u8 sText_ToxicSpikesPoisoned[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} ha estat\nenverienat!");
static const u8 sText_StickyWebSwitchIn[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} ha quedat\natrapat en una Teranyina!");
static const u8 sText_HealingWishCameTrue[] = _("El desig curatiu s'ha fet\nrealitat per {B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_HealingWishHealed[] = _("{B_ATK_NAME_WITH_PREFIX} ha recuperat salut!");
static const u8 sText_LunarDanceCameTrue[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha cobert\nde llum de lluna mística!");
static const u8 sText_CursedBodyDisabled[] = _("{B_BUFF1} de {B_ATK_NAME_WITH_PREFIX}\nha estat desactivat per\l{B_DEF_ABILITY} de {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_AttackerAquiredAbility[] = _("{B_ATK_NAME_WITH_PREFIX} ha adquirit {B_LAST_ABILITY}!");
static const u8 sText_TargetStatWontGoHigher[] = _("{B_BUFF1} de\n{B_DEF_NAME_WITH_PREFIX} no pujarà més!");
static const u8 sText_PkmnMoveBouncedViaAbility[] = _("{B_CURRENT_MOVE} de\n{B_ATK_NAME_WITH_PREFIX} ha rebotat\lper {B_DEF_ABILITY} de\l{B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_ImposterTransform[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha transformat\nen {B_DEF_NAME_WITH_PREFIX}\lamb {B_LAST_ABILITY}!");
static const u8 sText_NotDoneYet[] = _("Aquest efecte encara no\nestà implementat!\p");
static const u8 sText_PkmnBlewAwayToxicSpikes[] = _("{B_ATK_NAME_WITH_PREFIX} ha bufat\nles Trampes Tòxiques!");
static const u8 sText_PkmnBlewAwayStickyWeb[] = _("{B_ATK_NAME_WITH_PREFIX} ha bufat\nla Teranyina!");
static const u8 sText_PkmnBlewAwayStealthRock[] = _("{B_ATK_NAME_WITH_PREFIX} ha bufat\nla Roca Amagada!");
static const u8 sText_StickyWebUsed[] = _("Una Teranyina s'ha estès pel\nterra al voltant de l'equip\l{B_DEF_TEAM2}!");
static const u8 sText_QuashSuccess[] = _("El moviment del rival\n{B_ATK_NAME_WITH_PREFIX} s'ha ajornat!");
static const u8 sText_IonDelugeOn[] = _("Un diluvi d'ions cau\nsobre el camp de batalla!");
static const u8 sText_TopsyTurvySwitchedStats[] = _("Els canvis d'estad. de\n{B_DEF_NAME_WITH_PREFIX} s'han invertit!");
static const u8 sText_TerrainBecomesMisty[] = _("La boira ha cobert\nel camp de batalla!");
static const u8 sText_TerrainBecomesGrassy[] = _("L'herba ha crescut per cobrir\nel camp de batalla!");
static const u8 sText_TerrainBecomesElectric[] = _("Un corrent elèctric recorre\nel camp de batalla!");
static const u8 sText_TerrainBecomesPsychic[] = _("El camp s'ha tornat estrany!");
static const u8 sText_TargetElectrified[] = _("Els moviments de\n{B_DEF_NAME_WITH_PREFIX}\lhan estat electrificats!");
static const u8 sText_AssaultVestDoesntAllow[] = _("L'efecte de {B_LAST_ITEM} impedeix\nusar moviments d'estat!\p");
static const u8 sText_GravityPreventsUsage[] = _("{B_ATK_NAME_WITH_PREFIX} no pot usar\n{B_CURRENT_MOVE} per la gravetat!\p");
static const u8 sText_HealBlockPreventsUsage[] = _("S'ha impedit que\n{B_ATK_NAME_WITH_PREFIX} es curi!\p");
...
static const u8 sText_BestowItemGiving[] = _("{B_DEF_NAME_WITH_PREFIX} ha rebut\n{B_LAST_ITEM} de {B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_ThirdTypeAdded[] = _("S'ha afegit el tipus {B_BUFF1}\na {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_FellForFeint[] = _("{B_DEF_NAME_WITH_PREFIX} ha caigut\nen la finta!");
static const u8 sText_PokemonCannotUseMove[] = _("{B_ATK_NAME_WITH_PREFIX} no pot\nusar {B_CURRENT_MOVE}!");
static const u8 sText_CoveredInPowder[] = _("{B_DEF_NAME_WITH_PREFIX} està cobert de pols!");
static const u8 sText_PowderExplodes[] = _("Quan la flama ha tocat la pols\ndel Pokémon, ha explotat!");
static const u8 sText_BelchCantUse[] = _("No es pot usar Belch!\p");
static const u8 sText_SpectralThiefSteal[] = _("{B_ATK_NAME_WITH_PREFIX} ha robat\nles estad. pujades del rival!");
static const u8 sText_GravityGrounding[] = _("{B_DEF_NAME_WITH_PREFIX} no pot mantenir-se\nen l'aire per la gravetat!");
static const u8 sText_MistyTerrainPreventsStatus[] = _("{B_DEF_NAME_WITH_PREFIX} s'envolta\namb una boira protectora!");
static const u8 sText_GrassyTerrainHeals[] = _("{B_ATK_NAME_WITH_PREFIX} es cura\ngràcies al terreny herbós!");
static const u8 sText_ElectricTerrainPreventsSleep[] = _("{B_DEF_NAME_WITH_PREFIX} s'envolta\namb terreny electrificat!");
static const u8 sText_PsychicTerrainPreventsPriority[] = _("{B_DEF_NAME_WITH_PREFIX} s'envolta\namb terreny psíquic!");
static const u8 sText_SafetyGogglesProtected[] = _("{B_DEF_NAME_WITH_PREFIX} no es veu\nafectat gràcies a {B_LAST_ITEM}!");
static const u8 sText_FlowerVeilProtected[] = _("{B_DEF_NAME_WITH_PREFIX} s'ha envoltat\namb un vel de pètals!");
static const u8 sText_SweetVeilProtected[] = _("{B_DEF_NAME_WITH_PREFIX} s'ha envoltat\namb un vel de dolçor!");
static const u8 sText_AromaVeilProtected[] = _("{B_DEF_NAME_WITH_PREFIX} està protegit\nper un vel aromàtic!");
static const u8 sText_CelebrateMessage[] = _("Felicitats, {B_PLAYER_NAME}!");
static const u8 sText_UsedInstructedMove[] = _("{B_ATK_NAME_WITH_PREFIX} ha usat el\nmoviment instruït per {B_BUFF1}!");
static const u8 sText_LaserFocusMessage[] = _("{B_ATK_NAME_WITH_PREFIX}\ns'ha concentrat intensament!");
static const u8 sText_GemActivates[] = _("{B_LAST_ITEM} ha reforçat\nel poder de {B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_BerryDmgReducing[] = _("{B_LAST_ITEM} ha reduït el dany\na {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_TargetAteItem[] = _("{B_DEF_NAME_WITH_PREFIX} s'ha menjat {B_LAST_ITEM}!");
static const u8 sText_AirBalloonFloat[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} flota\namb {B_LAST_ITEM}!");
static const u8 sText_AirBalloonPop[] = _("{B_LAST_ITEM} de {B_DEF_NAME_WITH_PREFIX}\nha petat!");
static const u8 sText_IncinerateBurn[] = _("{B_LAST_ITEM} de\n{B_EFF_NAME_WITH_PREFIX} s'ha cremat!");
static const u8 sText_BugBite[] = _("{B_ATK_NAME_WITH_PREFIX} ha robat i\nmenjat {B_LAST_ITEM}\lde {B_EFF_NAME_WITH_PREFIX}!");
static const u8 sText_IllusionWoreOff[] = _("La Il·lusió de {B_DEF_NAME_WITH_PREFIX}\ns'ha esvaït!");
static const u8 sText_AttackerCuredTargetStatus[] = _("{B_ATK_NAME_WITH_PREFIX} ha curat\nel problema de {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_AttackerLostFireType[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha cremat!");
static const u8 sText_HealerCure[] = _("{B_LAST_ABILITY} de\n{B_ATK_NAME_WITH_PREFIX} ha curat\lel problema de\l{B_SCR_ACTIVE_NAME_WITH_PREFIX}!");
static const u8 sText_ReceiverAbilityTakeOver[] = _("{B_SCR_ACTIVE_ABILITY} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}\lha estat assumida!");
static const u8 sText_PkmnAbsorbingPower[] = _("{B_ATK_NAME_WITH_PREFIX} està absorbint poder!");
static const u8 sText_NoOneWillBeAbleToRun[] = _("Ningú podrà fugir\nal proper torn!");
static const u8 sText_DestinyKnotActivates[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} s'ha\nenamorat per {B_LAST_ITEM}!");
static const u8 sText_CloakedInAFreezingLight[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha cobert\nd'una llum gelada!");
static const u8 sText_StatWasNotLowered[] = _("{B_BUFF1} de\n{B_DEF_NAME_WITH_PREFIX} no ha baixat!");
static const u8 sText_AuraFlaredToLife[] = _("L'aura de {B_DEF_NAME_WITH_PREFIX}\ns'ha encès!");
static const u8 sText_AirLockActivates[] = _("Els efectes del temps\nhan desaparegut.");
static const u8 sText_PressureActivates[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} exerceix\nla seva pressió!");
...
static const u8 sText_AuraBreakActivates[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} ha invertit\nles aures dels altres Pokémon!");
static const u8 sText_ComatoseActivates[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} dormita!");
static const u8 sText_ScreenCleanerActivates[] = _("Totes les pantalles del camp\nhan estat eliminades!");
static const u8 sText_FetchedPokeBall[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} ha trobat\nun {B_LAST_ITEM}!");
static const u8 sText_BattlerAbilityRaisedStat[] = _("{B_SCR_ACTIVE_ABILITY} de\n{B_SCR_ACTIVE_NAME_WITH_PREFIX}\lha pujat {B_BUFF1}!");
static const u8 sText_ASandstormKickedUp[] = _("S'ha aixecat una tempesta de sorra!");
static const u8 sText_PkmnsWillPerishIn3Turns[] = _("Ambdós Pokémon es desmaiaran\nen tres torns!");
static const u8 sText_AbilityRaisedStatDrastically[] = _("{B_DEF_ABILITY} ha pujat {B_BUFF1}\nde {B_DEF_NAME_WITH_PREFIX}\ldràsticament!");
static const u8 sText_AsOneEnters[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} té dues Habilitats!");
static const u8 sText_CuriousMedicineEnters[] = _("Els canvis d'estad. de\n{B_EFF_NAME_WITH_PREFIX}\ls'han reiniciat!");
static const u8 sText_CanActFaster[] = _("{B_ATK_NAME_WITH_PREFIX} pot actuar\nmés ràpid gràcies a {B_BUFF1}!");
static const u8 sText_MicleBerryActivates[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} ha pujat la\nprecisió del proper moviment\lamb {B_LAST_ITEM}!");
static const u8 sText_PkmnShookOffTheTaunt[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} s'ha\nalliberat de la Provocació!");
static const u8 sText_PkmnGotOverItsInfatuation[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} ha superat\nel seu enamorament!");
static const u8 sText_ZPowerSurrounds[] = _("{B_ATK_NAME_WITH_PREFIX} s'envolta\namb el seu Poder Z!");
static const u8 sText_ZPowerUnleashed[] = _("{B_ATK_NAME_WITH_PREFIX} allibera\nel seu Moviment Z a fons!");
static const u8 sText_ZMoveResetsStats[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} ha tornat\nles estad. baixades a la\lnormalitat amb el Poder Z!");
static const u8 sText_ZMoveAllStatsUp[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} ha pujat\ntotes les estad. amb\lel Poder Z!");
static const u8 sText_ZMoveBoostCrit[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} ha pujat\nla ràtio de cops crítics\lamb el Poder Z!");
static const u8 sText_ZMoveRestoreHp[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} ha recuperat\nPS amb el Poder Z!");
static const u8 sText_ZMoveStatUp[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} ha pujat\nles estad. amb el Poder Z!");
static const u8 sText_ZMoveHpSwitchInTrap[] = _("Els PS de {B_SCR_ACTIVE_NAME_WITH_PREFIX}\nhan estat restaurats pel Poder Z!");
static const u8 sText_TerrainReturnedToNormal[] = _("El terreny ha tornat\na la normalitat!");
static const u8 sText_ItemCannotBeRemoved[] = _("L'objecte de {B_ATK_NAME_WITH_PREFIX}\nno es pot treure!");
static const u8 sText_StickyBarbTransfer[] = _("{B_LAST_ITEM} s'ha enganxat\na {B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnBurnHealed[] = _("La cremada de\n{B_DEF_NAME_WITH_PREFIX} s'ha curat.");
static const u8 sText_RedCardActivate[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} ha mostrat\n{B_LAST_ITEM} contra\l{B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_EjectButtonActivate[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} ha estat\ncanviat amb {B_LAST_ITEM}!");
static const u8 sText_AttackerGotOverInfatuation[] =_("{B_ATK_NAME_WITH_PREFIX} ha superat\nel seu enamorament!");
static const u8 sText_TormentedNoMore[] = _("{B_ATK_NAME_WITH_PREFIX} ja no\nestà turmentat!");
static const u8 sText_HealBlockedNoMore[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha curat\ndel bloqueig curatiu!");
static const u8 sText_AttackerBecameFullyCharged[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha carregat\ncompletament pel vincle\lamb l'entrenador!\p");
static const u8 sText_AttackerBecameAshSpecies[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha convertit\nen Ash-{B_BUFF1}!\p");
static const u8 sText_ExtremelyHarshSunlight[] = _("La llum solar s'ha tornat\nextremadament intensa!");
static const u8 sText_ExtremeSunlightFaded[] = _("La llum solar extrema s'ha esvaït.{PAUSE 64}");
static const u8 sText_MoveEvaporatedInTheHarshSunlight[] = _("L'atac d'Aigua s'ha evaporat\namb la llum solar intensa!");
static const u8 sText_ExtremelyHarshSunlightWasNotLessened[] = _("La llum solar extrema\nno ha disminuït gens!");
static const u8 sText_HeavyRain[] = _("Ha començat a caure una pluja forta!");
static const u8 sText_HeavyRainLifted[] = _("La pluja forta ha parat!{PAUSE 64}");
static const u8 sText_MoveFizzledOutInTheHeavyRain[] = _("L'atac de Foc s'ha apagat\namb la pluja forta!");
static const u8 sText_NoReliefFromHeavyRain[] = _("No hi ha alleujament\nd'aquesta pluja forta!");
static const u8 sText_MysteriousAirCurrent[] = _("Un corrent d'aire misteriós\nprotegeix els Pokémon Volador!");
static const u8 sText_StrongWindsDissipated[] = _("Els vents forts misteriosos\ns'han dissipat!{PAUSE 64}");
static const u8 sText_MysteriousAirCurrentBlowsOn[] = _("El corrent d'aire misteriós\ncontinua bufant!");
static const u8 sText_AttackWeakenedByStrongWinds[] = _("Els vents forts misteriosos\nhan debilitat l'atac!");
static const u8 sText_StuffCheeksCantSelect[] = _("No es pot seleccionar Stuff\nCheeks sense una Baia!\p");
static const u8 sText_PkmnRevertedToPrimal[] = _("Reversió Primigènia de\n{B_ATK_NAME_WITH_PREFIX}! Ha tornat\la la seva forma primigènia!");
static const u8 sText_ButPokemonCantUseTheMove[] = _("Però {B_ATK_NAME_WITH_PREFIX} no pot\nusar el moviment!");
static const u8 sText_ButHoopaCantUseIt[] = _("Però Hoopa no pot usar-ho\nen el seu estat actual!");
static const u8 sText_BrokeThroughProtection[] = _("Ha trencat la protecció\nde {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_AbilityAllowsOnlyMove[] = _("{B_ATK_ABILITY} només permet\nusar {B_CURRENT_MOVE}!\p");
static const u8 sText_SwappedAbilities[] = _("{B_DEF_NAME_WITH_PREFIX} ha intercanviat\nHabilitats amb l'objectiu!");
static const u8 sText_PastelVeilProtected[] = _("{B_DEF_NAME_WITH_PREFIX} està protegit\nper un vel pastel!");
static const u8 sText_PastelVeilEnters[] = _("{B_DEF_NAME_WITH_PREFIX} s'ha curat\ndel seu enverinament!");
static const u8 sText_BattlerTypeChangedTo[] = _("El tipus de {B_BUFF1}\nha canviat a {B_BUFF2}!");
static const u8 sText_BothCanNoLongerEscape[] = _("Cap Pokémon pot fugir!");
static const u8 sText_CantEscapeDueToUsedMove[] = _("{B_ATK_NAME_WITH_PREFIX} ja no pot fugir\nperquè ha usat {B_CURRENT_MOVE}!");
static const u8 sText_PkmnBecameWeakerToFire[] = _("{B_DEF_NAME_WITH_PREFIX} s'ha tornat\nmés feble al foc!");
static const u8 sText_PkmnAboutToBeAttackedByItsItem[] = _("{B_DEF_NAME_WITH_PREFIX} està a punt\nde ser atacat per {B_BUFF1}!");
static const u8 sText_CantEscapeBecauseOfCurrentMove[] = _("{B_DEF_NAME_WITH_PREFIX} ja no pot fugir\nper culpa de {B_CURRENT_MOVE}!");
static const u8 sText_NeutralizingGasEnters[] = _("El Gas Neutralitzant ha omplert la zona!");
static const u8 sText_NeutralizingGasOver[] = _("L'efecte del Gas\nNeutralitzant s'ha esgotat!");
static const u8 sText_PkmnTookTargetHigh[] = _("{B_ATK_NAME_WITH_PREFIX} ha portat\n{B_DEF_NAME_WITH_PREFIX} enlaire!");
static const u8 sText_TargetTooHeavy[] = _("Però l'objectiu\nera massa pesat!");
static const u8 sText_MeteorBeamCharging[] = _("{B_ATK_NAME_WITH_PREFIX} desborda\nd'energia espacial!");
static const u8 sText_HeatingUpBeak[] = _("{B_ATK_NAME_WITH_PREFIX} ha començat\na escalfar el bec!");
static const u8 sText_CourtChange[] = _("{B_ATK_NAME_WITH_PREFIX} ha intercanviat\nels efectes de cada costat!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_PLAYERPAIDPRIZEMONEYNOWHITEOUT - BATTLESTRINGS_TABLE_START] = sText_PlayerPaidPrizeMoneyNoWhiteout,
    ...
    [STRINGID_PLAYERDROPPEDMONEYNOWHITEOUT - BATTLESTRINGS_TABLE_START] = sText_PlayerDroppedMoneyNoWhiteout,
