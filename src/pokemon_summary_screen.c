...
const u8 sText_TitleMemo[] = _("Fitxa d'Entrenador");
const u8 sText_TitleSkills[] = _("Estad. Pokémon");
const u8 sText_TitleBattleMoves[] = _("Mov. Combat");
const u8 sText_TitleCondition[] = _("Condició");
const u8 sText_TitleContestMoves[] = _("Mov. Concurs");
const u8 sText_TitleRibbons[] = _("Cintes");
const u8 sText_TitleIVs[] = _("IVs Pokémon");
const u8 sText_TitleEVs[] = _("EVs Pokémon");
const u8 sText_TitlePage[] = _("{DPAD_LEFTRIGHT}Pàg.");
const u8 sText_TitlePageDetail[] = _("{DPAD_LEFTRIGHT}Pàg. {A_BUTTON}Detall");
const u8 sText_TitlePickSwitch[] = _("{DPAD_UPDOWN}Tria {A_BUTTON}Canvia");
const u8 sText_TitlePageIVs[] = _("{DPAD_LEFTRIGHT}Pàg. {A_BUTTON}IVs");
const u8 sText_TitlePageEVs[] = _("{DPAD_LEFTRIGHT}Pàg. {A_BUTTON}EVs");
const u8 sText_TitlePageStats[] = _("{DPAD_LEFTRIGHT}Pàg. {A_BUTTON}Estad.");
#else
const u8 sText_TitleInfo[] = _("INFO POKéMON");
const u8 sText_TitleMemo[] = _("FITXA D'ENTRENADOR");
const u8 sText_TitleSkills[] = _("ESTAD. POKéMON");
...
const u8 sText_None[] = _("Cap");
const u8 sText_Cancel[] = _("Cancel·lar");
const u8 sText_Power[] = _("Potència");
const u8 sText_Accuracy[] = _("Precisió");
const u8 sText_Appeal[] = _("Atractiu");
const u8 sText_Jam[] = _("Bloqueig");
const u8 sText_DexNo[] = _("Pokédex No.");
const u8 sText_Species[] = _("Nom");
const u8 sText_Type[] = _("Tipus");
const u8 sText_ExpPoints[] = _("Punts Exp.");
const u8 sText_ToNextLevel[] = _("Seg. Niv.");
const u8 sText_Attack[] = _("Atac");
...
const u8 sText_Cute[] = _("Bonic");
const u8 sText_Smart[] = _("Intel·ligent");
const u8 sText_Tough[] = _("Dur");
const u8 sText_HeldItem[] = _("Obj. equipat");
#else
const u8 sText_None[] = _("CAP");
const u8 sText_Cancel[] = _("CANCEL·LAR");
const u8 sText_Power[] = _("POTÈNCIA");
